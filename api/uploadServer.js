...
const contributeModel = require('../src/models/contributeModel');
const attachmentModel = require('../src/models/attachmentModel');
const { isAuthenticated } = require('../src/middlewares/authMiddleWares');
const connnect = require('../src/tools/connectToMongo');
const PORT = 9000;
connnect();
app.use(cors());
